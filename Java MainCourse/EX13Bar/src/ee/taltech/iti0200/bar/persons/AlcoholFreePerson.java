...
public class AlcoholFreePerson implements Person {

    private String drinkCategory;
    private List<Drink> drinkList = new ArrayList<>();
    private Bar.GetDrinkBy onlyDrinks = Bar.GetDrinkBy.NON_ALCOHOLIC;

    public AlcoholFreePerson(String drinkCategory) {
