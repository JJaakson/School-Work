...
class PremiumWashTest {
    ...
    private static final int CAR_DIRTINESS = 110;
    private static final int CAR_DIRTINESS_AFTER_WASH = 10;
    private static final int OWNER_BALANCE = 1000;
    private static final int OWNER_BALANCE_AFTER_DRY = 990;
    private static final int WASH_PRICE = 60;
    private static final int WASH_AND_DRY_PRICE = 70;

    private Car car;
    private CarOwner owner;
    private PremiumWash strategy;

    @BeforeEach
    void setUp() {
        car = new Car(CAR_DIRTINESS);
        owner = new CarOwner("Bond", OWNER_BALANCE);
        strategy = new PremiumWash();
    }
