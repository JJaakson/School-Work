...
class DrawingFullError(Exception):
    """Raise an Error, when drawing is full."""

    pass


class FigureDoesNotExistError(Exception):
    """Raise and Error, if a figure does not exist on the drawwing."""
...
class DrawingCanvas:
    ...
    def __init__(self, max_figures: int, author: str):
        ...
        You should initialize your variablees (properties) here.
    ...
    def draw_figure(self, figure: str) -> str or None:
        ...
        elif figure not in self.figures:
    ...
    def __str__(self):
        ...
        """
        amount = len(self.figures)
        return "The drawing painted by {}. Contains {} figure(s)".format(self.author, amount)
